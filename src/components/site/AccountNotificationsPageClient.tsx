...
export function AccountNotificationsPageClient({ locale }: AccountNotificationsPageClientProps) {
  ...
  return (
    <div className="space-y-6 rounded-2xl border border-zinc-200/70 bg-white p-6 shadow-sm dark:border-zinc-800/70 dark:bg-zinc-900">
      ...
      <div className="overflow-hidden rounded-xl border border-zinc-200 dark:border-zinc-800">
        ...
        {loading ? (
          ...
          <div className="px-5 py-8 text-sm text-zinc-500 dark:text-zinc-400">{t.emptyFiltered}</div>
        ) : (
