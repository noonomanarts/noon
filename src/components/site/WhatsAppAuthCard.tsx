...
export default function WhatsAppAuthCard({
  ...
  const t = useMemo(
    () => ({
      ...
      middleName: isArabic ? 'الاسم الأوسط (اختياري)' : 'Middle Name (optional)',
      ...
      <div className="mt-4 grid gap-4">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <button
            ...
            disabled={requesting}
            className="inline-flex items-center justify-center rounded-xl bg-[color:var(--noon-teal)] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[color:var(--noon-teal-strong)] disabled:cursor-not-allowed disabled:opacity-60"
          >
