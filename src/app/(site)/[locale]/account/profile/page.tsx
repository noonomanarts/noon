...
export default async function AccountProfilePage({
  ...
  return (
    <div className="rounded-none border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-sm">
      ...
      <div className="mt-6 flex items-center gap-4 rounded-none border border-[color:var(--border)] bg-[color:var(--muted)] p-4">
        <span className="keep-profile-round relative size-16 overflow-hidden rounded-full border border-[color:var(--border)] bg-[color:var(--surface)]">
          {user.profileImage ? (
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-none border border-[color:var(--border)] bg-[color:var(--muted)] p-4">
