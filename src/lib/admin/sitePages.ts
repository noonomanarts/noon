...
export const sitePageCatalog: SitePageDefinition[] = [
  ...
  },
  {
    ...
    descriptionAr: "صفحة البحث الشامل للورش والمحتوى.",
    defaultNavPlacement: "PRIMARY",
    defaultFooterVisible: true,
  },
  {
  ...
  },
  {
    ...
    descriptionAr: "الصفحة الجامعة لجميع الورش.",
    defaultNavPlacement: "PRIMARY",
    defaultFooterVisible: true,
  },
  {
    ...
    descriptionAr: "صفحة قائمة ورش الطبخ.",
    defaultNavPlacement: "PRIMARY",
    defaultFooterVisible: true,
  },
  {
    ...
    nameAr: "ورش الفنون والأشغال",
    descriptionEn: "Arts and crafts classes listing page.",
    descriptionAr: "صفحة قائمة ورش الفنون والأشغال.",
    defaultNavPlacement: "PRIMARY",
    defaultFooterVisible: true,
  },
  {
  ...
  const aboutPage: AboutPageSettings =
    page.key === "about"
      ? {
          ...
          whatWeDoItems: [
            { textEn: "Expert-led, hands-on classes", textAr: "ورش عملية بقيادة خبراء" },
